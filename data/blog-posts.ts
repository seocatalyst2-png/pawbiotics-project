...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: "Can Cats Eat Blueberries? Safety, Portions, and When to Skip Them",
    metaTitle: "Can Cats Eat Blueberries? Safe Treat Guide for Cat Owners",
    metaDescription:
      "Can cats eat blueberries safely? Learn portion tips, choking and stomach risks, when to avoid blueberries, and better treat habits.",
    category: "Cats",
    publishedDate: "2026-05-03",
    readingTime: "9 min read",
    intro:
    ...
    featuredImage: {
      ...
      caption: "Blueberries should be rare, tiny treats for cats, not a regular nutrition source.",
    },
    sections: [
      { heading: "Quick answer: can cats eat blueberries?", paragraphs: ["Yes, many healthy cats can eat one or two plain blueberries as an occasional treat. Blueberries should be washed, cut if needed, and offered in tiny amounts only."] },
      { heading: "Safety note", paragraphs: ["Ask your vet before offering fruit if your cat has diabetes, obesity risk, digestive disease, food allergies, or active vomiting or diarrhea."] },
      { heading: "Do cats need blueberries?", paragraphs: ["No. Cats are obligate carnivores and get their core nutrition from complete cat food. Blueberries are optional enrichment, not a health treatment."] },
      { heading: "How to offer safely", paragraphs: ["Keep the test simple so you can spot a reaction."], bullets: ["Wash well", "Offer one tiny piece first", "No sugar, yogurt, or syrup", "Do not force interest", "Monitor stool and appetite"] },
      { heading: "When to skip blueberries", paragraphs: ["Some cats should avoid fruit treats."], bullets: ["Diabetes or weight-loss plan", "Sensitive stomach", "Active vomiting or diarrhea", "History of food reactions", "Cat refuses or seems stressed"] },
      { heading: "Common mistakes", paragraphs: ["Fruit becomes risky when owners treat it like a daily health food."], bullets: ["Giving too many berries", "Using sweetened blueberry foods", "Ignoring calories", "Trying fruit during GI upset", "Replacing balanced treats"] },
      { heading: "When to Call a Vet", paragraphs: ["Call if your cat vomits repeatedly, develops diarrhea, stops eating, shows lethargy, or has swelling, hives, or breathing changes after a new food."] },
      { heading: "Key Takeaways", paragraphs: ["Blueberries can be safe, but they are optional."], bullets: ["Tiny amounts only", "Plain and washed", "Avoid for diabetic or GI-sensitive cats", "Cat food should remain the main diet"] },
    ],
    faqs: [
      { question: "Are blueberries toxic to cats?", answer: "Blueberries are not considered toxic to most cats, but they can still cause stomach upset if overfed." },
      { question: "How many blueberries can a cat eat?", answer: "One or two tiny pieces is plenty for most healthy cats. Many cats do not want fruit at all, and that is fine." },
      { question: "Can kittens eat blueberries?", answer: "Kittens should focus on complete kitten food. Fruit treats are unnecessary and may upset digestion." },
      { question: "Can cats eat blueberry yogurt?", answer: "Blueberry yogurt is not ideal because it may contain sugar, dairy, flavors, or sweeteners. Use plain cat-safe treats instead." },
      { question: "What if my cat vomits after blueberries?", answer: "Stop offering blueberries and monitor closely. Repeated vomiting, appetite loss, or low energy needs veterinary advice." },
      { question: "Which page should I read next?", answer: "Read [can cats eat banana](/blog/can-cats-eat-banana) for another fruit safety guide." },
    ],
    internalLinks: [
      { label: "Can cats eat banana?", href: "/blog/can-cats-eat-banana" },
      { label: "Cats that puke", href: "/blog/cats-that-puke" },
