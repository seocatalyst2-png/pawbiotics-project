...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "PawBiotics internal links for readers", paragraphs: ["Start at the [PawBiotics homepage](/), then browse [cat guides](/cats), [dog guides](/dogs), [pet tools](/tools), [probiotic education](/probiotics), [health condition guides](/health-conditions), and the [local vet directory](/vets).", "Useful next reads include [can cats eat eggs](/blog/can-cats-eat-eggs), [can cats have peanut butter](/blog/can-cats-have-peanut-butter), [cats that puke](/blog/cats-that-puke), [average cat lifespan](/blog/average-cat-lifespan), and [cat gut health guide](/blog/cat-gut-health-guide). For tool pages, visit the [probiotic calculator](/tools/probiotic-calculator), [dog food calculator](/tools/dog-food-calculator), and [puppy feeding schedule](/tools/puppy-feeding-schedule)."] },
    ],
    faqs: [
