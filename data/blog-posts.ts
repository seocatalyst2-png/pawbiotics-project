...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: "Bleeding Poop in Dogs: Causes, Urgency, and What to Do",
    metaTitle: "Bleeding Poop in Dogs: When Blood in Stool Is Urgent",
    metaDescription:
      "Learn what bleeding poop in dogs can mean, red flag symptoms, what details to track, and when to contact a veterinarian urgently.",
    category: "Dogs",
    publishedDate: "2026-05-01",
    readingTime: "10 min read",
    intro:
    ...
    featuredImage: {
      src: "/images/blog/bleeding-poop-dog.png",
      alt: "Worried dog owner at a veterinary clinic discussing a stool concern",
